      ...
      <div className="grid grid-cols-1 md:hidden gap-5">
        {filteredWorkers.map((worker) => (
          <motion.div
            ...
            className="bg-white rounded-3xl border shadow p-5"
          >
            <div className="flex items-center gap-4">
              <img
                src={getImageUrl(worker.profileImage)}
              ...
              <div>
                <h2 className="font-bold text-lg">{worker.user?.fullName}</h2>
            ...
            <div className="grid grid-cols-2 gap-3 mt-5">
              ...
              <div className="bg-slate-50 rounded-xl p-3">
                ...
                <p className="font-semibold text-sm">⭐ {worker.rating || 0}</p>
              </div>
              ...
              <div className="bg-slate-50 rounded-xl p-3">
                ...
                <p className="font-semibold text-sm">{worker.availability}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 mt-6">
              <button
                onClick={() => navigate(`/admin/workers/${worker._id}`)}
                className="flex justify-center items-center gap-1 py-2 rounded-xl bg-blue-100 text-blue-700 text-sm font-semibold"
              >
                <FiEye />
                View
              </button>
              ...
              <button
                onClick={() => handleToggleStatus(worker)}
                className="flex justify-center items-center gap-1 py-2 rounded-xl bg-yellow-100 text-yellow-700 text-sm font-semibold"
              >
                {worker.user?.isActive ? <FiShieldOff /> : <FiShield />}
              </button>
              ...
              <button
                onClick={() => handleDelete(worker)}
                className="flex justify-center items-center gap-1 py-2 rounded-xl bg-red-100 text-red-700 text-sm font-semibold"
              >
                <FiTrash2 />
              </button>
            </div>
